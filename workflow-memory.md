...
> **Note:** The active, prescriptive workflow that agents should follow for day-to-day editing and GitHub backup is now documented in **`WORKFLOW.md`** (in the same repository). This `workflow-memory.md` file serves as historical context and incident log.
